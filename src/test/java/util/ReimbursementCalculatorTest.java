...
class ReimbursementCalculatorTest {
    ...
    void shouldCalculateTotalReimbursement() {
        ...
        Receipt receipt = new Receipt(1, 1,"plane", BigDecimal.valueOf(99.9));
        Receipt receipt1 = new Receipt(2, 1, "hotel", BigDecimal.valueOf(50.9));
        Receipt receipt2 = new Receipt(3, 1,"ticket", BigDecimal.valueOf(11.9));
        Receipt receipt3 = new Receipt(4, 1,"meal", BigDecimal.valueOf(12.9));
